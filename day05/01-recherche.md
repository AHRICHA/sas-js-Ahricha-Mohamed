...
**Ma réponse : la chaine de caractere n'accepte pas la modification direct ,donc il ete immuable au cas nous avons utiliser toUpperCasse() il ne doit pas changer l'ancient "string" . **
...
**Ma réponse : j'ai trouver que tous slice, substring , substr fais la meme mission dans les petit taches ,avec un difference , slice & substring uutilise end mais substr() uutilise lenght, danc dans la progmation la methode qui deprecie oou moins recommande c'est substr **
